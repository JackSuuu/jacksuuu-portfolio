        ...
        <section className="mb-10">
            <div class="flex justify-between items-center p-7 text-white">
                ...
                <ul class="flex justify-between item-center p-3 gap-x-3 border border-3.5 rounded-lg">
                    <li><a href="#intro-page" class="transition duration-300 ease-in-out hover:text-[#DBDBDB]">Intro</a></li>
            ...
            <div class="p-10 text-white flex flex-col items-center justify-center bg-background text-foreground">
                <div class="relative">
                    ...
                    <h1 className={`text-8xl mt-10 absolute left-[30px] bottom-[-40px] font-inter`}>
                        JACK SU
                    </h1>
                    <div class="flex justify-between gap-x-6 text-m text-[#DBDBDB] absolute mt-15 bottom-[-80px] font-inter @media (min-width: 800px){
                        bottom-[-120px]
                    }">
